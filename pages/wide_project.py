...
with col1:
    st.markdown(
        ...
        <p style='font-size:26px; font-family: "Barlow"'>Bem vindo ao simulador, {st.session_state.assessor}</p>
        ''',
...
################################# LAYOUT DO CONTEÚDO ##################################
#######################################################################################
retorno, ano1_avg, ano2_avg  = st.columns([5, 5, 5])
...
with cliente:
    ...
    htmlstr = f'''<p style='background-color: #9966ff;  font-family: "Knockout"; color: #FFF; font-size: 20px; border-radius: 7px; padding-left: 8px; text-align: center'>Carteira de Clientes</style></p>'''
