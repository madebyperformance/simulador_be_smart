...
def besmart_base_2(
    data, data_inicial, face, empresa, categoria, produto, pl_apl:None, roa_reps:None, roa_rec=0,impost=0.2, corretag=0
):
    if pl_apl is None:
        # Código ou tratamento para o caso em que pl_apl não é fornecido
        # Por exemplo:
        pl_apl = 0  # Definindo o valor padrão para pl_apl como 0
    if roa_reps is None:
        # Código ou tratamento para o caso em que roa_reps não é fornecido
        # Por exemplo:
        roa_reps = 0
